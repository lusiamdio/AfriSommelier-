    ...
    <div className="min-h-screen bg-wine-900 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <button 
          ...
          className="w-full bg-ivory text-wine-900 font-medium py-4 rounded-2xl hover:scale-[0.98] transition-transform flex items-center justify-center gap-3 shadow-xl"
        >
